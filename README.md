...
## What we did 
In this work, we developed an \textit{ab initio} method to build the thermal equilibrium Wigner $P$-function and Husimi $Q$-function using Ceperley's classical open polymer model. We also solved the equation of motion for quantum phase point with the correct deformation at thermal equilibrium. To see the mathematics and physics in this project, please refer to the .pdf document in this repo. 
